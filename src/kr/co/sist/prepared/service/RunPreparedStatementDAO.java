...
public class RunPreparedStatementDAO {
	...
	public void addEmp() {
		...
		if (inputData!=null) {
			...
			try {
				...
				try {
					preparedStatementDAO.insertEMP(employeeVO);
	...
	public void modifyEmp() {
		...
		if (inputData!=null) {
			...
			try {
				...
				PreparedStatementDAO preparedStatementDAO = PreparedStatementDAO.getInstance();
				int cnt = preparedStatementDAO.updateEmp(employeeVO);
	...
	public int removeEmp() {
	    ...
	    try {
	        ...
	        PreparedStatementDAO preparedStatementDAO = PreparedStatementDAO.getInstance();
	        cnt = preparedStatementDAO.deleteEmp(empno);
	        if (cnt > 0) {
	...
	public static void main(String[] args) {
		RunPreparedStatementDAO runStatementDAO = new RunPreparedStatementDAO();
